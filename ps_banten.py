...
def main():
    ...
    '''
    weather_file = r'/sites/amandemen/data/presentweather-banten.csv'
    output_file = r'/sites/amandemen/data/merged_data_banten.csv'
    json_file = r'/sites/amandemen/data/outputbanten_ps.json'
