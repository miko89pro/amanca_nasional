...
def main():
    ...
    '''
    weather_file = r'/sites/amandemen/data/presentweather-jakarta.csv'
    output_file = r'/sites/amandemen/data/merged_data_jakarta_ps.csv'
    json_file = r'/sites/amandemen/data/outputjakarta_ps.json'
