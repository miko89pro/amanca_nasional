...
def main(file_input):
    ...
    '''
    lokasi = file_input.split('-')[1].split('.')[0]
    weather_file = f'/sites/amandemen/data/presentweather-{lokasi}.csv'
    output_file = f'/sites/amandemen/data/merged_data_{lokasi}.csv'
    json_file = f'/sites/amandemen/data/output{lokasi}_ps.json'
    ...
    print(lokasi, weather_file, output_file, json_file)
